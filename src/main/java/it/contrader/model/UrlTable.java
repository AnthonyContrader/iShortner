...
public class UrlTable {
	...
	public UrlTable(String longUrl, String shortUrl, int fkIdUser) {
	...
	public UrlTable(int id, String longUrl, String shortUrl, int fkIdUser) {
		this.id = id;
		this.longUrl = longUrl;
		this.shortUrl = shortUrl;
		this.fkIdUser = fkIdUser;
