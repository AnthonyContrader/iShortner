package com.ishortner.repository;

import com.ishortner.GatewayApp;

import com.ishortner.config.Constants;
import com.ishortner.config.audit.AuditEventConverter;
import com.ishortner.domain.PersistentAuditEvent;
...
import static com.ishortner.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
